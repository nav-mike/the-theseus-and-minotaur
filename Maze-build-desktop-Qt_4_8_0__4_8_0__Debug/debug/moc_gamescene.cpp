...
**
** Created: Sun Feb 19 10:53:13 2012
...
static const char qt_meta_stringdata_GameScene[] = {
    "GameScene\0"
};
...
const QMetaObjectExtraData GameScene::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GameScene::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_GameScene,
      qt_meta_data_GameScene, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GameScene::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameScene))
